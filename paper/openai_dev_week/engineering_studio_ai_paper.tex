...
\begin{proof}
The proof proceeds in three enumerated stages: (1) enumeration of the
route requirement sets as declared in the router configuration,
(2) verification of registry membership for every element appearing
in those sets, and (3) closure of the universal claim by finite case
exhaustion. Each stage is stated and justified without omission.
...
\begin{proof}
Immediate from Theorem~\ref{thm:route-registry-closure}.
\end{proof}
